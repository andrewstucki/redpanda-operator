...
// PostUpgradeJobApplyConfiguration represents an declarative configuration of the PostUpgradeJob type for use
// with apply.
...
// PostUpgradeJobApplyConfiguration constructs an declarative configuration of the PostUpgradeJob type for use with
// apply.
